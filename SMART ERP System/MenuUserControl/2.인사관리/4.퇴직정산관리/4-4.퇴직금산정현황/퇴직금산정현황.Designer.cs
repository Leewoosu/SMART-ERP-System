namespace SMART_ERP_System.MenuUserControl
{
	partial class 퇴직금산정현황
	{
		...
		private void InitializeComponent()
		{
			...
			this.comboBox5.Location = new System.Drawing.Point(479, 14);
			...
			this.label8.Location = new System.Drawing.Point(424, 17);
			this.label8.Name = "label8";
			this.label8.Size = new System.Drawing.Size(49, 11);
			this.label8.TabIndex = 22;
			this.label8.Text = "사원코드";
			// 
			// label7
			// 
			...
			this.comboBox1.Size = new System.Drawing.Size(78, 19);
			...
			this.label4.Text = "지급기간";
			// 
			// dateTimePicker3
			// 
			this.dateTimePicker3.Location = new System.Drawing.Point(426, 40);
			...
			// dateTimePicker4
			// 
			this.dateTimePicker4.Location = new System.Drawing.Point(230, 39);
			this.dateTimePicker4.Name = "dateTimePicker4";
			this.dateTimePicker4.Size = new System.Drawing.Size(169, 21);
			...
			this.comboBox2.Location = new System.Drawing.Point(230, 13);
			this.comboBox2.Name = "comboBox2";
			this.comboBox2.Size = new System.Drawing.Size(169, 19);
			...
			this.tabControl1.Size = new System.Drawing.Size(900, 555);
			...
			this.dataGridView4.Size = new System.Drawing.Size(886, 523);
			this.dataGridView4.TabIndex = 6;
			// 
			// Column15
			// 
			this.Column15.HeaderText = "사원코드";
			this.Column15.Name = "Column15";
			this.Column15.Width = 80;
			// 
			// Column16
			// 
			this.Column16.HeaderText = "사원명";
			this.Column16.Name = "Column16";
			this.Column16.Width = 80;
			// 
			// Column17
			// 
			this.Column17.HeaderText = "부서코드";
			this.Column17.Name = "Column17";
			this.Column17.Width = 80;
			// 
			// Column18
			// 
			this.Column18.HeaderText = "부서";
			this.Column18.Name = "Column18";
			this.Column18.Width = 80;
			// 
			// Column19
			// 
			this.Column19.HeaderText = "직책코드";
			this.Column19.Name = "Column19";
			this.Column19.Width = 80;
			// 
			// Column20
			// 
			this.Column20.HeaderText = "직책";
			this.Column20.Name = "Column20";
			this.Column20.Width = 80;
			// 
			// Column21
			// 
			this.Column21.HeaderText = "귀속년월";
			this.Column21.Name = "Column21";
			this.Column21.Width = 80;
			// 
			// Column22
			// 
			this.Column22.HeaderText = "지급일자";
			this.Column22.Name = "Column22";
			this.Column22.Width = 80;
			// 
			// Column23
			// 
			this.Column23.HeaderText = "입사일";
			this.Column23.Name = "Column23";
			this.Column23.Width = 80;
			// 
			// Column24
			// 
			this.Column24.HeaderText = "기산일";
			this.Column24.Name = "Column24";
			this.Column24.Width = 80;
			// 
			// Column1
			// 
			this.Column1.HeaderText = "퇴사일";
			this.Column1.Name = "Column1";
			this.Column1.Width = 80;
			// 
			// Column2
			// 
			this.Column2.HeaderText = "산정일수";
			this.Column2.Name = "Column2";
			this.Column2.Width = 80;
			// 
			// Column3
			// 
			this.Column3.HeaderText = "마감여부";
			this.Column3.Name = "Column3";
			this.Column3.Width = 60;
			// 
			// Column4
			// 
			this.Column4.HeaderText = "차인지급액";
			this.Column4.Name = "Column4";
			this.Column4.Width = 90;
			// 
			// Column5
			// 
			this.Column5.HeaderText = "연금계좌입금액";
			this.Column5.Name = "Column5";
			this.Column5.Width = 90;
			// 
			// Column6
			// 
			this.Column6.HeaderText = "이연퇴직소득세";
			this.Column6.Name = "Column6";
			this.Column6.Width = 90;
			// 
			// Column7
			// 
			this.Column7.HeaderText = "퇴직금";
			this.Column7.Name = "Column7";
			this.Column7.Width = 90;
			// 
			// Column8
			// 
			this.Column8.HeaderText = "단체퇴직보험금";
			this.Column8.Name = "Column8";
			this.Column8.Width = 90;
			// 
			// Column9
			// 
			this.Column9.HeaderText = "명예퇴직수당등";
			this.Column9.Name = "Column9";
			this.Column9.Width = 90;
			// 
			// Column10
			// 
			this.Column10.HeaderText = "퇴직연금";
			...
			this.dataGridView2.Size = new System.Drawing.Size(886, 523);
			this.dataGridView2.TabIndex = 7;
			// 
			// dataGridViewTextBoxColumn1
			// 
			this.dataGridViewTextBoxColumn1.HeaderText = "사원코드";
			this.dataGridViewTextBoxColumn1.Name = "dataGridViewTextBoxColumn1";
			this.dataGridViewTextBoxColumn1.Width = 80;
			// 
			// dataGridViewTextBoxColumn2
			// 
			this.dataGridViewTextBoxColumn2.HeaderText = "사원명";
			this.dataGridViewTextBoxColumn2.Name = "dataGridViewTextBoxColumn2";
			this.dataGridViewTextBoxColumn2.Width = 80;
			// 
			// dataGridViewTextBoxColumn3
			// 
			this.dataGridViewTextBoxColumn3.HeaderText = "부서코드";
			this.dataGridViewTextBoxColumn3.Name = "dataGridViewTextBoxColumn3";
			this.dataGridViewTextBoxColumn3.Width = 80;
			// 
			// dataGridViewTextBoxColumn4
			// 
			this.dataGridViewTextBoxColumn4.HeaderText = "부서";
			this.dataGridViewTextBoxColumn4.Name = "dataGridViewTextBoxColumn4";
			this.dataGridViewTextBoxColumn4.Width = 80;
			// 
			// dataGridViewTextBoxColumn5
			// 
			this.dataGridViewTextBoxColumn5.HeaderText = "직책코드";
			this.dataGridViewTextBoxColumn5.Name = "dataGridViewTextBoxColumn5";
			this.dataGridViewTextBoxColumn5.Width = 80;
			// 
			// dataGridViewTextBoxColumn6
			// 
			this.dataGridViewTextBoxColumn6.HeaderText = "직책";
			this.dataGridViewTextBoxColumn6.Name = "dataGridViewTextBoxColumn6";
			this.dataGridViewTextBoxColumn6.Width = 80;
			// 
			// dataGridViewTextBoxColumn7
			// 
			this.dataGridViewTextBoxColumn7.HeaderText = "귀속년월";
			this.dataGridViewTextBoxColumn7.Name = "dataGridViewTextBoxColumn7";
			this.dataGridViewTextBoxColumn7.Width = 80;
			// 
			// dataGridViewTextBoxColumn8
			// 
			this.dataGridViewTextBoxColumn8.HeaderText = "지급일자";
			this.dataGridViewTextBoxColumn8.Name = "dataGridViewTextBoxColumn8";
			this.dataGridViewTextBoxColumn8.Width = 80;
			// 
			// dataGridViewTextBoxColumn12
			// 
			this.dataGridViewTextBoxColumn12.HeaderText = "신고대상세액";
			this.dataGridViewTextBoxColumn12.Name = "dataGridViewTextBoxColumn12";
			this.dataGridViewTextBoxColumn12.Width = 90;
			// 
			// dataGridViewTextBoxColumn13
			// 
			this.dataGridViewTextBoxColumn13.HeaderText = "연금계좌취급자";
			this.dataGridViewTextBoxColumn13.Name = "dataGridViewTextBoxColumn13";
			this.dataGridViewTextBoxColumn13.Width = 95;
			// 
			// Column11
			// 
			this.Column11.HeaderText = "사업자등록번호";
			...
			// Column13
			// 
			this.Column13.HeaderText = "입금일";
			this.Column13.Name = "Column13";
			this.Column13.Width = 80;
			// 
			// Column14
			// 
			this.Column14.HeaderText = "계좌입금금액";
			this.Column14.Name = "Column14";
			this.Column14.Width = 90;
			// 
			// Column25
			// 
			this.Column25.HeaderText = "퇴직급여";
			this.Column25.Name = "Column25";
			// 
			// Column26
			// 
			this.Column26.HeaderText = "이연퇴직소득세";
			this.Column26.Name = "Column26";
			this.Column26.Width = 95;
			// 
			// Column27
			// 
			this.Column27.HeaderText = "이연퇴직지방소";
			this.Column27.Name = "Column27";
			this.Column27.Width = 95;
			// 
			// dataGridViewTextBoxColumn21
			// 
			this.dataGridViewTextBoxColumn21.HeaderText = "사원코드";
			this.dataGridViewTextBoxColumn21.Name = "dataGridViewTextBoxColumn21";
			this.dataGridViewTextBoxColumn21.Width = 80;
			// 
			// dataGridViewTextBoxColumn22
			// 
			this.dataGridViewTextBoxColumn22.HeaderText = "사원명";
			this.dataGridViewTextBoxColumn22.Name = "dataGridViewTextBoxColumn22";
			this.dataGridViewTextBoxColumn22.Width = 80;
			// 
			// dataGridViewTextBoxColumn24
			// 
			this.dataGridViewTextBoxColumn24.HeaderText = "부서";
			this.dataGridViewTextBoxColumn24.Name = "dataGridViewTextBoxColumn24";
			this.dataGridViewTextBoxColumn24.Width = 80;
			// 
			// dataGridViewTextBoxColumn26
			// 
			this.dataGridViewTextBoxColumn26.HeaderText = "직책";
			this.dataGridViewTextBoxColumn26.Name = "dataGridViewTextBoxColumn26";
			this.dataGridViewTextBoxColumn26.Width = 80;
			// 
			// dataGridViewTextBoxColumn27
			// 
			this.dataGridViewTextBoxColumn27.HeaderText = "귀속년월";
			this.dataGridViewTextBoxColumn27.Name = "dataGridViewTextBoxColumn27";
			this.dataGridViewTextBoxColumn27.Width = 80;
			// 
			// dataGridViewTextBoxColumn28
			// 
			this.dataGridViewTextBoxColumn28.HeaderText = "지급일자";
			this.dataGridViewTextBoxColumn28.Name = "dataGridViewTextBoxColumn28";
			this.dataGridViewTextBoxColumn28.Width = 80;
			// 
			// Column28
			// 
			this.Column28.HeaderText = "근무처명";
			this.Column28.Name = "Column28";
			this.Column28.Width = 80;
			// 
			// Column29
			// 
			this.Column29.HeaderText = "사업자등록";
			this.Column29.Name = "Column29";
			this.Column29.Width = 80;
			// 
			// Column30
			// 
			this.Column30.HeaderText = "퇴직급여";
			this.Column30.Name = "Column30";
			this.Column30.Width = 80;
			// 
			// Column31
			// 
			this.Column31.HeaderText = "비과세퇴직";
			this.Column31.Name = "Column31";
			this.Column31.Width = 80;
			// 
			// Column32
			// 
			this.Column32.HeaderText = "과세퇴직급";
			this.Column32.Name = "Column32";
			this.Column32.Width = 80;
			// 
			// Column33
			// 
			this.Column33.HeaderText = "소득세";
			this.Column33.Name = "Column33";
			this.Column33.Width = 80;
			// 
			// Column34
			// 
			this.Column34.HeaderText = "지방소득세";
			this.Column34.Name = "Column34";
			this.Column34.Width = 80;
			// 
			// Column35
			// 
			this.Column35.HeaderText = "농어촌특별";
